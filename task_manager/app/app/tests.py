...
class ViewTests(TestCase):
    ...
    def test_view_team_detail_with_no_permission(self):
        ...
        url = reverse('app:team_detail', kwargs={'team_id': self.team1.id})
    ...
    def test_view_team_add_member_without_permission(self):
        ...
        """
        self.client.force_login(self.u3)
        url = reverse('app:team_add_member', kwargs={'team_id': self.team2.id})
    ...
    def test_view_team_remove_member_with_permission(self):
        ...
        url = reverse('app:team_remove_member', kwargs={'team_id': team.id})
    ...
    def test_view_delete_team(self):
        ...
        team.members.add(self.u3)
        url = reverse('app:team_delete', kwargs={'team_id': team.id})
        response = self.client.get(url)
        redirect_url = reverse('app:index')
        self.assertRedirects(response, redirect_url)
    ...
    def test_view_task_edit_without_permission(self):
        ...
        """
        self.client.force_login(self.u1)
        url = reverse('app:task_edit', kwargs={'task_id': self.task2.id})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 403)
    ...
    def test_view_task_delete_without_permission(self):
        ...
        """
        self.client.force_login(self.u1)
        url = reverse('app:task_delete', kwargs={'task_id': self.task2.id})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 403)
    ...
    def test_view_task_delete_with_permission(self):
        ...
        url = reverse('app:task_delete', kwargs={'task_id': task.id})
        response = self.client.get(url)
        redirect_url = reverse('app:index')
        self.assertRedirects(response, redirect_url)
    ...
    def test_view_task_detail_without_permission(self):
        ...
        """
        self.client.force_login(self.u3)
        url = reverse('app:task_detail', kwargs={'task_id': self.task2.id})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 403)
    ...
    def test_view_task_comment_without_permission(self):
        ...
        """
        self.client.force_login(self.u3)
        url = reverse('app:task_comment', kwargs={'task_id': self.task2.id})
